  ...
  return (
    <div className="max-w-2xl mx-auto py-20 px-6">
      <div className="text-center mb-10">
        ...
        <h1 className="text-4xl font-bold text-amber-900 mb-4">Newsletter</h1>
      ...
      <ul className="mt-10 space-y-3 text-sm text-gray-500">
        <li className="flex items-center gap-2">
          <span className="text-amber-600">✓</span> Gratuit, pour toujours
        </li>
        <li className="flex items-center gap-2">
          <span className="text-amber-600">✓</span> Deux fois par mois, pas plus
        </li>
        <li className="flex items-center gap-2">
          <span className="text-amber-600">✓</span> Désabonnement en un clic
        </li>
      </ul>
    </div>
  );
